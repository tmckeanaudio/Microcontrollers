...
void DAC_Pin_Configuration(void){
	...
	// Note from Yifeng: This switch is for ADC. However, for DAC, this bit is irrelevant!
...
void DAC_Configuration(void){
	...
	DAC->CR &= ~DAC_CR_TSEL2;
	DAC->CR |= ( DAC_CR_TSEL2_0 | DAC_CR_TSEL2_2); // Select 101 TIM4_TRGO as DAC triggers for Channel 2
